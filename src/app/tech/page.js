...
export default function TechPage() {
  // This is the "Engine" - it switches the Hubs without reloading the page
  ...
  return (
    ...
    >
      ...
      {/* ─── HUB 1: PERFORMANCE (The Live Feed) ─── */}
      ...
      {activeHub === "EA Shop" && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-in slide-in-from-bottom-4 duration-500">
          <Card className="bg-[#0F1A1A] border-[#1A302E]">
            ...
            <p className="text-[#7A9E99] text-sm font-light mb-6 leading-relaxed">{getContent('ea-1', 'body', "Multi-timeframe breakout EA with prop firm compliance and session-aware entries.")}</p>
          ...
          <Card className="border-[#20B2AA]/40 bg-[#0F1A1A] shadow-[0_0_50px_rgba(32,178,170,0.1)]">
            ...
            <p className="text-[#7A9E99] text-sm font-light mb-6 leading-relaxed">{getContent('ea-bundle', 'body', "Full ecosystem access: all current EAs, future releases, and private Discord.")}</p>
